...
const DEFAULTS: FormValues = {
  name: "", slug: "",
  name_i18n_en: "", name_i18n_es: "", name_i18n_fr: "",
  description_i18n_en: "", description_i18n_es: "", description_i18n_fr: "",
  mode: "solo", category: "general", dataset_id: "",
  question_count: 10, min_players: 1, max_players: 1,
  question_type: "mcq_4", flag_variant: "flag_to_name_4",
  continent: "", include_territories: false,
  score_mode: "classic", time_bonus: false,
  points_per_correct: 100, xp_multiplier: 1, is_active: true,
};
...
export default function TemplateCreatePage() {
  ...
  useEffect(() => { setValue("dataset_id", ""); }, [isGeoCategory]);
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      ...
      const created = await gameTemplatesService.createTemplate({
        name: data.name,
        slug: data.slug,
  ...
  return (
    <PageContainer>
      <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 4 }}>
        ...
        <Typography variant="subtitle1" fontWeight={600}>New template</Typography>
      </Box>

      <Box component="form" id="template-create-form" onSubmit={onSubmit}>
        <Stack spacing={5}>
